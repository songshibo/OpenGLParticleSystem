...
const float f_bottom_radius = 0.05f;
const float f_cone_angle = 45.0f;
...
int main()
{
    ...
    while(glfwWindowShouldClose(window) == false)
    {
        ...
        total = merge_one(spark_manager, sparkCount, instance_pos_size, instance_lifetime);
        ...
        glDrawElementsInstanced(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0, sparkCount);
